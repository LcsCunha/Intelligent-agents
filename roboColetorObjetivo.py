...
class roboColetorObjetivo (roboColetor):
  ...
  def checalixo(self, ambiente):
    ...
    if espaco == 1 or espaco == 2: #Se o espaço estiver sujo
      ...
      ambiente[y][x] = " "
      return ambiente
    elif right == 2 or right == 1 and not lim_right:
      self.localAtual['x'] += 1
      return ambiente
    elif left == 2 or left == 1 and not lim_left:
      self.localAtual['x'] -= 1
      return ambiente
    elif down == 2 or down == 1 and not lim_down:
      self.localAtual['y'] += 1
      return ambiente
    elif up == 2 or up == 1 and not lim_up:
      self.localAtual['y'] -= 1
      return ambiente
